...
|---|---|---|
| <ApiRef uid="Repl.ReplDateRange" /> | `DateOnly` | Whole days only |
| <ApiRef uid="Repl.ReplDateTimeRange" /> | `DateTime` | Any duration |
| <ApiRef uid="Repl.ReplDateTimeOffsetRange" /> | `DateTimeOffset` | Any duration |
...
- [Routes & Parameters](/reference/routes-and-parameters/) — full route constraint syntax, named options, <ApiRef uid="Repl.Parameters.ReplOptionsGroupAttribute" label="[ReplOptionsGroup]" />, and parameter binding rules.
