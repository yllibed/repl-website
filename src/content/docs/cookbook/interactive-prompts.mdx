...
This makes interactive commands fully scriptable without changing handler code. Prompt names match the first argument to `AskTextAsync` / `AskChoiceAsync` / `AskBoolAsync`.
