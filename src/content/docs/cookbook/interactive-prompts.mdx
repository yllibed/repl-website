...
Inject <ApiRef uid="Repl.Interaction.IReplInteractionChannel" /> (namespace `Repl.Interaction`) to ask the user questions mid-command:
...
- [Interactivity](/reference/interactivity/) — complete prompt API: all prompt types, progress reporting, MCP interaction tiers, and `--answer:*` flag semantics.
