...
| `.WithCompletion(provider)` | Registers Tab completion for this route. An optional `CompletionProviderScope` argument (default `Interactive`) opts the provider into shell completion (`InteractiveAndShell`) |
